        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            <a href="?halaman=warga" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a href="?halaman=kk" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a href="?halaman=layanan" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a href="?halaman=akun" class="nav-link">
            ...
            <section class="content">
                ...
                if (@$_GET['halaman']) {
                    switch (@$_GET['halaman']) {
                        ...
                        case 'akun':
                            include 'halaman/kelola_akun.php';
                            break;

                        case 'kk':
                            include 'halaman/kelola_kk.php';
                            break;

                        case 'warga':
                            include 'halaman/kelola_warga.php';
                            break;

                        case 'layanan':
                            include 'halaman/kelola_layanan.php';
                            break;
